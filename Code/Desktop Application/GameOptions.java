...
public class GameOptions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter The Length Of Secret Code");
        ...
        jLabel4.setText("Select The Number Of Characters");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText(":");

        jSlider1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jSlider1.setMajorTickSpacing(6);
        jSlider1.setMaximum(61);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jSlider1, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            secretCodeLength = Integer.parseInt(jTextField1.getText());// TODO add your handling code here:
            int numberOfSymbols = jSlider1.getValue();
        
            if (numberOfSymbols == 0) {
                JOptionPane.showMessageDialog(rootPane, "Secret code charactes length should be greater than 0");
            } else {
                BullsAndCows bullsAndCows = new BullsAndCows(secretCodeLength, numberOfSymbols);
